...
# -*- encoding: utf-8 -*-
'''
@File    :   Built-in Exceptions.py
@Time    :   2019/04/22 21:12:50
@Author  :   leacoder
@Version :   1.0
@Contact :   leacock1991@gmail.com
@License :   
@Desc    :  
python 3.7.3 标准库  内置异常
python 3.7.3  https://docs.python.org/3/library/exceptions.html#built-in-exceptions
'''

# here put the import lib

# 可参考 http://www.runoob.com/python3/python3-errors-execptions.html
...
# Exception hierarchy EndException hierarchy